...
![https://www.north-47.com/knowledge-base/testing-spring-boot-application/](<../.gitbook/assets/image (41).png>)
...
![https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#using-boot-starter](broken-reference)
